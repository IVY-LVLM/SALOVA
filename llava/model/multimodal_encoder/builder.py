...
from .siglip_encoder import SigLipVisionTower, SigLipTextTower
from .clip_encoder import CLIPVisionTower, CLIPVisionTowerS2, CLIPTextTower, BERTTextTower
...
def build_text_tower(text_tower_cfg, **kwargs):
    ...
    # use_s2 = getattr(text_tower_cfg, "s2", False)
    ...
    elif text_tower.startswith("bert"):
        return BERTTextTower(text_tower, args=text_tower_cfg, **kwargs)
    elif text_tower.startswith("google"):
        return SigLipTextTower(text_tower, text_tower_cfg=text_tower_cfg, **kwargs)
