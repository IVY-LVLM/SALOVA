...
DATA_PATH=${DATA_PATH:-"/path/to/sft_meta.json"}
...
OUTPUT_DIR=${OUTPUT_DIR:-"/path/to/output/${run_name:-stage3_salova}/"}

deepspeed --master_addr 127.0.0.1 --master_port 12333 --include localhost:0,1,2,3,4,5,6,7 llava/train/train_mem.py \
